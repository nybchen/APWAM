...
def build_panda_gripper_grasp_pose_visual(scene: ManiSkillScene, visual_name: str = "grasp_pose_visual"):
    ...
    grasp_pose_visual = builder.build_kinematic(name=visual_name)
