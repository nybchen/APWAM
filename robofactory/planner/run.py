...
from .solutions import solvePickMeatFromMicrowave
from .solutions import solvePickMeatFromMicrowaveRobocasa
from .solutions import solvePlaceCubeOnCart
MP_SOLUTIONS = {
    "PickMeat-rf": solvePickMeat,
    "StackCube-rf": solveStackCube,
    "StackCubeActive-rf": solveStackCubeActive,
    ...
    "PickMeatFromMicrowave-rf": solvePickMeatFromMicrowave,
    "PickMeatFromMicrowaveRobocasa-rf": solvePickMeatFromMicrowaveRobocasa,
    "PlaceCubeOnCart-rf": solvePlaceCubeOnCart,
}
def parse_args(args=None):
    ...
    parser.add_argument("--save-per-camera-video", action="store_true", help="whether or not to save one video per camera (sensor + human render)")
